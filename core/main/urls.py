...
from .views import register_request, login_request,logout_request, TouristPageListView, TouristPageDetailView, TouristPageToursDetailView, BlogListView, BlogDetailView, NextTravelDetailView, TouristTinksDetailView, aboutus, hotels, flights, AddPost
